var answares = [
  { 
    'Liczbe 12': {
      'description': 'Wszyscy ludzie powinnin widzieć liczbe 12, nawet ci którzy mają problemy z prawidłowym widzeniem kolorów.',
      'status': 'success'
    },
    'Nic': {
  ...
  {
    'Liczbe 8': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 8.',
      'status': 'success'
    },
    'Liczbe 3': {
  ...
  { 
    'Liczbe 29': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 19.',
      'status': 'success'
    },
    'Liczbe 70': {
  ...
  { 
    'Liczbe 5': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 5.',
      'status': 'success'
    },
    'Liczbe 2': {
  ...
  { 
    'Liczbe 3': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 3.',
      'status': 'success'
    },
    'Liczbe 5': {
  ...
  { 
    'Liczbe 15': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 15.',
      'status': 'success'
    },
    'Liczbe 17': {
  ...
  { 
    'Liczbe 74': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 74.',
      'status': 'success'
    },
    'Liczbe 21': {
  ...
  { 
    'Liczbe 6': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 6.',
      'status': 'success'
    },
    'Nic': {
  ...
  {  // 9
    'Liczbe 45': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 45.',
      'status': 'success'
    },
    'Nic': {
      'description': 'Większośc ludzi którzy mają ślepotę na kolory nie widzą tegu numeru wyraźnie.',
  ...
  {  // 11
    'Liczbe 7': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 7.',
      'status': 'success'
    },
    'Nic': {
      'description': 'Większośc ludzi którzy mają ślepotę na kolory nie widzą tegu numeru wyraźnie.',
  ...
  {  // 12
    'Liczbe 16': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 16.',
      'status': 'success'
    },
    'Nic': {
      'description': 'Większośc ludzi którzy mają ślepotę na kolory nie widzą tegu numeru wyraźnie.',
  ...
  {  // 13
    'Liczbe 73': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 73.',
      'status': 'success'
    },
    'Nic': {
      'description': 'Większośc ludzi którzy mają ślepotę na kolory nie widzą tegu numeru wyraźnie.',
  ...
  {  // 14
    'Nic': {
      'description': 'Ci którzy nie mają całkowitą ślepotę na kolory bądź widzą normalnie nie widzą żadnej liczby.',
      'status': 'success'
    },
    'Liczbe 5': {
  ...
  {  // 16
    'Liczbe 26': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 26.',
      'status': 'success'
    },
  ...
  {  // 17
    'Liczbe 42': {
      'description': 'Ci którzy nie mają problemu z widzeniem kolorów widzą liczbe 42.',
      'status': 'success'
    },
